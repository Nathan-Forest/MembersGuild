    ...
    <div style={{ background: dark, color: '#fff', minHeight: '100vh', fontFamily: 'system-ui, sans-serif' }}>
      ...
      <nav style={{
        ...
        <div style={{ display: 'flex', gap: '2rem', alignItems: 'center' }}>
          {[['#features', 'Features'], ['#pricing', 'Pricing'], ['/register', 'Register'], ['#support', 'Support']].map(([href, label]) => (
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(240px, 1fr))', gap: '1.5rem', marginBottom: '2rem' }}>
            {standardPlans.map(plan => (
              <div key={plan.name} style={{
                ...
                <a href={`/register?plan=${plan.id}`} style={{
        ...
        <div style={{ maxWidth: '40rem', margin: '0 auto' }}>
          <div style={{ textAlign: 'center', marginBottom: '3rem' }}>
            ...
            <p style={{ color: muted, fontSize: '0.95rem', lineHeight: 1.8 }}>
              Have questions before committing? Fill in your details and
